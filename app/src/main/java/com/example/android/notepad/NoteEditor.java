 ...
 */
public class NoteEditor extends Activity implements Command, ServerAddress{
    ...
    public static ServiceReply reply = new ServiceReply();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Intent.ACTION_EDIT.equals(action)) {
            ...
            Log.d("NoteEditor:onCreate", "update remote database");
    ...
    protected void onPause() {
        ...
        if (mCursor != null) {
            ...
            if (isFinishing() && (length == 0)) {
            	...
            	Log.d("NoteEditor:onPause", "call updateNote(), mState == STATE_EDIT");
                updateNote(text, null);
                
                                
            } else if (mState == STATE_INSERT) {
            	Log.d("NoteEditor:onPause", "call updateNote(), mState == STATE_INSERT");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case R.id.menu_save:
            String text = mText.getText().toString();
            Log.d("NoteEditor:onOptionsItemSelected", "call updateNote()");
            updateNote(text, null);
            finish();
            break;
    ...
    private final void performPaste() {
        ...
        if (clip != null) {
            ...
            Log.d("NoteEditor:performPaste", "call updateNote()");
    ...
    private final void updateNote(String text, String title) {
        ...
        Log.d("NoteEditor:updateNote", "update remote database");
        
        
        Log.d("NoteEditor:updateNote", "prepare query uri" + uri.toString());
    ...
    private final void cancelNote() {
        if (mCursor != null) {
            if (mState == STATE_EDIT) {
                ...
                //Log.d("NoteEditor:cancelNote", "update remote database");
    ...
    private final void deleteNote() {
        if (mCursor != null) {
            ...
            Log.d("NoteEditor:deleteNote", "update remote database");            
            
            startDBServiceForDeletion(mUri);             
            
            
            new SaveDatabaseAfterDeletionTask(this).execute();
            
            mText.setText("");
        }
    }
    
    public boolean startDBServiceForDeletion(Uri mUri) {
		...
		Log.d("startDBServiceForDeletion", "start service to delete " + mUri.toString());
		startService(intent);
    ...
    private class SaveDatabaseAfterDeletionTask extends AsyncTask<Void, Void, String>{
    	
    	Cursor cursor;
    	Context context;
    	
    	SaveDatabaseAfterDeletionTask(Context context){
    		super();
